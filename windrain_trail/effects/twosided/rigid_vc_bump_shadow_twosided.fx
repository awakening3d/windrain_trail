...
vector __vFactor = {0.5, 0,0,0}; // alpha test

struct VS_OUTPUT {
   float4 Pos: POSITION;
   float4 uv : TEXCOORD0;	// xy: uv, z,w: diffuse & specular adjust
...
technique T0
{
  pass P1
  {
	...
	//AlphaBlendEnable = True; // will affect dynamic lighting blending
  }
} //of technique T0
