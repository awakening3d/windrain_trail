...
vector vecUVRipple={1,1,0,0}; //uvRipple = uvRipple * vecUVRipple.xy + vecUVRipple.zw
float fRippleStrength=0.1f;
...
float4 mainps(VS_OUTPUT In) : COLOR0
{
	...
	float2 ripple= tex2D(texRipple,In.uv1 * vecUVRipple.xy + vecUVRipple.zw)*fRippleStrength;
	float2 uvofs=(bump.xy * __vFactor.w  + ripple) * saturate( (1-In.dist*8) );
