...
vector vecFactorScale = { 0.1, 0.1, 0.001, .1 }; // x: shell distance scale, y: uvscale scale, z: uvoffset scale, w: color scale
	...
	mul r1, r1, c15
	max r1, r1, c5.z
	// r0, r1 must keep value

	// light 2
	mov r3, c16 // c16 - light2 pos
	m4x3 r2, r3, c8 // light position to object space
	add  r2, r2, -v0		// L = lpos - vertex, L in object space

	// normalize vector in r2
	dp3  r2.w, r2, r2		// r2.w = |r2|^2
	rsq  r2.w, r2.w			// r2.w = 1/sqrt{r2.w} = 1/|r2|
	mul  r2.xyz, r2, r2.w	// r2 - normalized L vector

	dp3 r2, r2, v1
	mul r2, r2, c17 // c17 - light2 color
	max r2, r2, c5.z


	add r1, r1, r2 // ligth1 + light2
...
//ColorArg2[0] = Specular;
  ...
  AlphaOp[0] = SelectArg1;
	...
	VertexShaderConstant[16] = <_vecLight1>; //light1
	VertexShaderConstant[17] = <_vecLightColor1>; //light1 color

	VertexShaderConstant[64] = <vecFactorScale>; // factor scale
...
//	CullMode=None;
  ...
  pass P13
  {
	VertexShaderConstant[5] = {13,0,0,0}; //pass
  }
