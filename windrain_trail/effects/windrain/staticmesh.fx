...
VS_OUTPUT mainvs(float3 vPosition: POSITION, float2 uv: TEXCOORD0, float3 n: NORMAL, float3 vcolor: COLOR0, float3 bin: BINORMAL, float3 tan: TANGENT)
{
	VS_OUTPUT o;
